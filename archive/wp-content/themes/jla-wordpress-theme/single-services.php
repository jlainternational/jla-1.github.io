...
?>
         ...
         <section id="pageIntroHead" class="sectionSpace">
            <h1 class="row column lightFont sectionLeadTitle">Services <span class="currentColor">| <?php echo get_the_title(); ?> </span></h1>
          ...
          <section id="sectorDetails" class="row sectionSpace last">
			...
			if(!empty($loop)) :  ?>
                ...
                <div class="fsBig lightFont">More Services</div>
