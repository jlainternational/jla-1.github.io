        	...
        	pagePillingWrap.each(function () {
        		...
        		that.pagepiling({
        			...
        			onLeave: function(index, nextIndex, direction){
        				...
        				if (color === 'light') header.find('.logo img').attr('src', '<?php echo esc_url($tatee_option['media_logo']['url']); ?>');
        				else header.find('.logo img').attr('src', '<?php echo esc_url($tatee_option['media_logo_2']['url']); ?>');
